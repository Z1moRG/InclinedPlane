...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{distance\_monitor\_low\_latency\_with\_button.py} -- Specjalistyczna, docelowa wersja aplikacji zoptymalizowana pod kątem redukcji opóźnień w systemach operacyjnych z rodziny Windows. 
        ...
        \item \texttt{serial\_dev\_harmonics.py} (pełni podobną funkcję do \texttt{serial\_dev.py})
    \end{itemize}
\end{itemize}
...
.3 distance\_monitor\_low\_latency\_with\_button.py
.3 serial\_dev.py.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{} l l X @{}}
        ...
        12       & Przycisk (Styk A)             & Sygnał wejściowy (funkcja \texttt{INPUT\_PULLUP}). \\ 
